...
export const Logo404Generated: React.FC<{}> = observer(props => {
  return (
    <>
      <div className="figma-1">
        <div id="20:22" className="figma-0">
          ...
          <div className="figma-9">
            <div id="20:27" className="figma-8">
              <svg
              ...
              >
                ...
                />
                <path
                  d="M20.3 9.70001L17.65 17.65L9.70001 20.3L12.35 12.35L20.3 9.70001Z"
                  stroke="white"
                  strokeLinecap="round"
                  strokeWidth="2"
                />
      ...
      <style jsx>{`
        ...
        .figma-8 {
          ...
          margin-right: 21.666666666666668%;
          min-width: 50%;
          max-width: 50%;
          debug-v: SCALE;
          height: 50%;
          top: 21.666666666666668%;
          bottom: 28.333333333333332%;
          min-height: 50%;
          max-height: 50%;
        }
        .figma-9 {
