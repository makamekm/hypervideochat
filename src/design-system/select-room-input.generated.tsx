...
export const SelectRoomInputGenerated: React.FC<{ value?: string; onChange?: React.ChangeEventHandler<HTMLInputElement> }> = observer(
  props => {
          ...
          <div id="1:8" className="figma-0 input-wrapper">
            <div className="figma-5">
              <div id="1:7" className="figma-4 input">
                <input id="1:7" value={value} onChange={onChange} className="figma-3 input" type="text" placeholder="Room ID..." />
              </div>
            </div>
