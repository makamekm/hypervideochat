...
export const SettingButtonGenerated: React.FC<{
  ...
  return (
    <>
      <div className="figma-1">
        <div id="29:8" tabIndex={0} onKeyDown={onKeyDown} onClick={onClick} className="figma-0 button">
          <div className="figma-5">
            <div id="29:9" className="figma-4">
              <svg
